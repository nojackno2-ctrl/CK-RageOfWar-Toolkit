...
// Complete dictionary for help.json
const baseDict = {
  "Game Basics": "ゲームの基本",
  "Fog of war": "戦争の霧",
  "Map": "マップ",
  ...
  "Requires Woman breastplates": "「女性用胸甲」が必要",
  ...
  "Village hall": "村役場",
  "House": "民家",
  "Gates, Towers and Walls": "城門、監視塔、防壁",
  "Wooden Shipyard": "木造造船所",
  "Stone Shipyard": "石造造船所",
  "Caves": "洞窟",
  "Well": "井戸",
  ...
  "The townhall is the most important structure of a stronghold. It is there that units usually gather, and mules bring food or gold from villages and outposts. Whoever controls the townhall controls all structures in the stronghold.":
    "町役場は要塞内で最も重要な中枢建築です。部隊が集合し、荷ロバが村や前哨基地から食料やゴールドを運び込みます。町役場を支配する者が、要塞内のすべての施設を掌握します。",

  "Commands": "コマンド",
  "Creates Mule with food": "食料積載の荷ロバを生産",
  "Creates Mule with gold": "ゴールド積載の荷ロバを生産",
  "Repair (visible when damaged)\r\nCost: 500 gold; Time: 60 sec": "修復（損壊時に表示）\r\nコスト：500 ゴールド；時間：60 秒",
  ...
  "The barracks are a training ground where a villager is made into a warrior. The building can exist only within the stronghold. In order for barracks to produce the specified type of warrior his equipment must already be created in the town blacksmith.":
    "兵舎は村人を戦士へと鍛え上げる訓練場です。要塞内にのみ存在します。兵舎で特定の兵種を訓練するには、あらかじめ町の鍛冶屋で対応する装備を研究しておく必要があります。",

  "Faster warrior equipment I, II, III\r\nCost: 500 gold; Time: 60 sec":
    "兵員装備の迅速化 I, II, III\r\nコスト：500 ゴールド；時間：60 秒",

  "Equip Spearman\r\nCost: 120 gold; Time: 2 - 16 sec":
    "槍兵を装備\r\nコスト：120 ゴールド；時間：2 - 16 秒",

  "Equip Woman Warrior\r\nCost: 220 gold; Time: 3 - 20 sec":
    "女戦士を装備\r\nコスト：220 ゴールド；時間：3 - 20 秒",
  ...
  "Taverns are meeting places where news is exchanged and deals made. People come from all over the world and always have something to sell.":
    "酒場は情報交換や商談が行われる交流の場です。世界中から人々が集まり、様々な物資や取引を持ちかけます。",

  "Add 10 Population\r\nAdds 10 peasants to the stronghold population\r\nCost: 400 food; Time: 10 sec":
    "人口を10人追加\r\n要塞の人口を農民10人分増加させる\r\nコスト：400 食料；時間：10 秒",

  "Call peasants\r\nCalls 5 peasants of the population":
    "農民を募集\r\n要塞人口から農民5人を召集する",

  "Equip Archer\r\nCost: 80 gold; Time: 2 - 10 sec":
    "弓兵を装備\r\nコスト：80 ゴールド；時間：2 - 10 秒",

  "Equip Archer\r\nCost: 40 gold; Time: 2 - 10 sec":
  ...
  "Training I (requires Gladiator shows)\r\nAllows training of units to level 4\r\nCost: 1000 gold; Time: 25 sec":
    "訓練 I（要「剣闘士興行」）\r\nユニットをレベル4まで訓練可能\r\nコスト：1000 ゴールド；時間：25 秒",
  ...
  "Altar of Jupiter\r\nAllows Priests to practice their skills\r\nCost: 1000 gold; Time: 15 sec":
    "ユピテルの祭壇\r\n神官の修行・奇跡を解放\r\nコスト：1000 ゴールド；時間：15 秒",

  "Cloud of Plague (requiers Altar of Jupiter)\r\nCost: 2000 gold; Time: 20 sec":
    "疫病の雲（要「ユピテルの祭壇」）\r\nコスト：2000 ゴールド；時間：20 秒",

  "Wrath of Jupiter (requiers Altar of Jupiter)\r\nCost: 2000 gold; Time: 20 sec":
    "ユピテルの怒り（要「ユピテルの祭壇」）\r\nコスト：2000 ゴールド；時間：20 秒",

  "Gaul Village hall": "ガリアの村役場",
  "Roman Village hall": "ローマの村役場",

  "The village hall is the center of a village. It stores the village surplus food and can be ordered to send it elsewhere. Whoever controls the village hall controls the entire village.":
    "村役場は村の中枢施設です。村の余剰食料を備蓄し、命令に応じて他拠点へ輸送します。村役場を掌握する者が、村全体を統治します。",

  "Tribute\r\nSends automatically all resources to another outpost, village or stronghold":
    "貢納\r\nすべての資源を別の前哨基地、村、または要塞へ自動輸送",

  "Gaul House": "ガリアの民家",
  "Roman House": "ローマの民家",

  "Houses provide additional living space. They add 10 to the maximum population of the village or stronghold they belong to.":
    "民家は追加の居住空間を提供します。所属する村や要塞の人口上限を10人増加させます。",

  "Gaul Gates, Towers and Walls": "ガリアの城門、監視塔、防壁",
  "Roman Gates, Towers and Walls": "ローマの城門、監視塔、防壁",

  "The fortifications defend the interior of a stronghold. \r\nThe walls are an unpenetratable barrier. The gates automatically close when there are enemies around. The towers fire arrows at the enemy. The more people in the stronghold the faster the towers' fire rate.":
    "要塞の内部を守る防衛構造物群です。\r\n防壁は通過不可能な堅牢な障壁です。敵が接近すると城門は自動的に閉じ、監視塔は敵軍へ矢を射掛けます。要塞内の人口が多いほど、監視塔の射撃速度が向上します。",

  "Gate Commands": "城門コマンド",
  "Open Gate": "城門を開く",
  "Close Gate": "城門を閉じる",

  "Outposts are fortified buildings that have several entrances allowing units to enter quickly from any direction. They store resources, defend and heal all units inside.\r\nThe outpost automatically fires arrows at nearby enemy units. The rate of fire depends on the number of units inside the outpost.\r\nIn addition to its strategic value a wooden outpost can sell food for gold.":
    "前哨基地は複数の出入口を備えた要塞化建築であり、部隊があらゆる方角から素早く退避・出撃できます。物資を備蓄し、内部の部隊を守り治療します。\r\n基地は付近の敵に自動で矢を放ちます。射撃速度は内部の駐留部隊数に比例します。\r\n木造前哨基地では戦略的利点に加え、食料を売却してゴールドを得ることができます。",

  "Sell food\r\nStarts selling 20 food for 10 gold every 2 seconds":
    "食料売却\r\n2秒ごとに食料20を売却してゴールド10を獲得",

  "Outposts are small buildings defended with fence that have several entrances allownig units to enter quickly from any direction. They store resources, defend and heal all units inside.\r\nThe outpost automatically fires arrows at nearby enemy units. The rate of fire depends on the number of units inside the outpost.\r\nWhen 2000 gold are stored in a stone outpost, it will provide interest of 8 gold every 2 seconds.":
    "石造前哨基地は柵と堅固な壁で守られた防衛施設で、部隊が各方向から素早く出入りできます。資源を備蓄し、内部の部隊を防護・治癒します。\r\n付近の敵に自動で矢を放ち、射撃速度は駐留部隊数に比例します。\r\n石造前哨基地にゴールドが2000以上蓄積されると、2秒ごとに8ゴールドの利息を生み出します。",

  "Wooden and Stone Shipyard": "木造・石造造船所",

  "Shipyards are places where ships are built and units sent across rivers and seas. Because of their nature both boats and mules can enter them.\r\nThe shipyard uses boats when instructed to tribute resources to another shipyard.\r\nMules are used to tribute resources to an outpost, village or stronghold.":
    "造船所は船舶を建造し、部隊を水上輸送するための拠点です。その性質上、小型船と荷ロバの双方が進入可能です。\r\n他の造船所へ資源を輸送する際は小型船を用い、前哨基地・村・要塞へ輸送する際は荷ロバを用います。",

  "Tribute\r\nSends automatically all resources to another shipyard, outpost, village or stronghold.":
    "貢納\r\nすべての資源を別の造船所、前哨基地、村、または要塞へ自動輸送",

  "Creates Boat with food": "食料積載の小型船を建造",
  "Creates Boat with gold": "ゴールド積載の小型船を建造",
  "Build ship": "大型戦船を建造",
  ...
  "The Teuton tent is an isolated settlement of a small Teuton tribe. When independent the tent supports up to 50 Teuton Riders and Archers. After a player conquers the tent he can order the garrison that is reduced to maximum of 20 warriors.\r\nThe tent garrison increases with 2 warriors every 32 seconds up to the current maximum.":
    "テウトンの天幕は、テウトン小部族の孤立した集落です。独立状態の天幕は最大50体のテウトン騎兵および弓兵を維持します。プレイヤーが制圧すると最大20体までの駐留軍を指揮できます。\r\n天幕の駐留兵は32秒ごとに2体ずつ補充され、上限まで増強されます。",

  "Garrisoned by Teuton Rider": "テウトン騎兵を駐留",
  "Garrisoned by Teuton Archer": "テウトン弓兵を駐留",
  "Affected by Teuton uprising ritual": "「テウトン蜂起の儀式」の影響を受ける",

  "Ancient and mysterious it is said that the arcane structure or stonehenge holds many secrets. Believed to be built by the druids a stonehenge represents one of the greatest sacred places where druids perform their rituals. Lately roman priests too have acquired the knowledge to use its powers for their own needs.\r\nA few druids or priests gathered at the stonehenge can perform arcane rituals that influence the whole world.":
    "古代の神秘に包まれた巨石構造物ストーンヘンジは、数多くの秘儀を宿していると言われます。ドルイドによって建造されたと信じられており、彼らが神聖な儀式を執り行う至高の聖地です。近年ではローマの神官もその力を活用する秘術を習得しました。\r\nストーンヘンジに複数のドルイドまたは神官が集うことで、全世界に影響を及ぼす強大な秘術儀式を執り行えます。",

  "Wind of wisdom ritual\r\nIncreases the level of all existing units below level 20 with the number of sacrificing druids or priests. \r\nRequires at least 1 duird or priest":
    "叡智の風の儀式\r\n生贄となるドルイドまたは神官の数に応じて、レベル20未満の全ユニットのレベルを上昇させる。\r\n必要数：ドルイドまたは神官1名以上",

  "Starvation ritual\r\nSlowly decreases all food supplies for 5 minutes\r\nRequires 3 duirds or priests":
    "飢餓の儀式\r\n5分間にわたり、すべての食料備蓄を徐々に減少させる。\r\n必要数：ドルイドまたは神官3名以上",

  "Golden rain ritual\r\nSlowly adds gold to every settlement for 2 minutes\r\nRequires 5 duirds or priests":
    "黄金の雨の儀式\r\n2分間にわたり、すべての拠点にゴールドを持続的に付与する。\r\n必要数：ドルイドまたは神官5名以上",

  "Death wish ritual\r\nDrains the life out of every druid and priest for 1 minute\r\nRequires 6 duirds or priests":
    "死の宿願の儀式\r\n1分間にわたり、すべてのドルイドと神官の生命力を急速に奪う。\r\n必要数：ドルイドまたは神官6名以上",

  "Bloodlust ritual\r\nEnables all units to inflict maximum damage for 6 minutes\r\nRequires 8 duirds or priests":
    "血の狂乱の儀式\r\n6分間にわたり、全ユニットの攻撃が常に最大ダメージとなる。\r\n必要数：ドルイドまたは神官8名以上",

  "Teuton uprising ritual\r\nStarts a Teuton uprising in every Teuton tent\r\nRequires 10 duirds or priests":
    "テウトン蜂起の儀式\r\nすべてのテウトンの天幕でテウトン人の一斉蜂起を引き起こす。\r\n必要数：ドルイドまたは神官10名以上",
